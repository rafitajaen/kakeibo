...
internal static partial class ClickHouseAuditServiceLogs
{
    ...
    internal static partial void ClickHouseUnavailableSkipping(this ILogger logger, string action, Guid userId);
    ...
    internal static partial void ClickHouseUnavailableAuditFailed(this ILogger logger, string action, Guid userId, Exception exception);

    [LoggerMessage(1103, LogLevel.Debug,
        "ClickHouse unavailable — returning empty activity feed for user {UserId}")]
    internal static partial void ClickHouseUnavailableActivityFeed(this ILogger logger, Guid userId);

    [LoggerMessage(1104, LogLevel.Warning,
        "ClickHouse unavailable — activity feed will return empty until restart. UserId={UserId}")]
    internal static partial void ClickHouseUnavailableActivityFeedFailed(this ILogger logger, Guid userId, Exception exception);
}
