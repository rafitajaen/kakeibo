...
internal static partial class WebPushServiceLogs
{
    ...
    internal static partial void ExpiredSubscriptionRemoved(ILogger logger, Guid userId);

    [LoggerMessage(1402, LogLevel.Warning,
        "Failed to send push notification to user {UserId}")]
    internal static partial void PushNotificationFailed(ILogger logger, Guid userId, Exception exception);
}
