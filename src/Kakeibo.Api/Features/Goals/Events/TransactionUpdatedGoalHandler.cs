...
// Recalculates CurrentProgress for goals linked to the updated transaction's wallet.
// Uses WalletBalance.Balance for self-healing correctness.
// Publishes milestone events if the recalculated balance crosses a new threshold.
public sealed class TransactionUpdatedGoalHandler(AppDbContext db, IEventBus eventBus)
